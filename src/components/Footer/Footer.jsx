    ...
    <footer className="footer">
      <div className="footer__top">
        ...
        <nav className="footer__nav" aria-label="Navegación del footer">
          <h3 className="footer__subtitle">Navegación</h3>

          <ul className="footer__list">
            <li><a href="/">Inicio</a></li>
            <li><a href="#que-hacemos">Qué hacemos</a></li>
            <li><a href="#asociate">Asóciate</a></li>
        ...
        <div className="footer__social">
          ...
          <ul className="footer__list">
            <li><a href="#" aria-label="Instagram de AXUDI">Instagram</a></li>
            <li><a href="#" aria-label="TikTok de AXUDI">TikTok</a></li>
            <li><a href="#" aria-label="LinkedIn de AXUDI">LinkedIn</a></li>
          </ul>
        </div>
    ...
    <li>
      ...
      <div className="footer__bottom">
        ...
        <p className="footer__credits">
          Web creada por{' '}
          <a href="#" aria-label="Web de Cristina en Órbita">
            Cristina en Órbita
          </a>
        </p>
      </div>
